...
def main():
    ...
    header_html = f"""
    <div id="dallepic"style="background-image: url('{background_image_url}'); background-size: cover; background-repeat: no-repeat; padding: 20px; text-align: center; height: 90%; width: 100%; display: flex; align-items: center; justify-content: center;">
